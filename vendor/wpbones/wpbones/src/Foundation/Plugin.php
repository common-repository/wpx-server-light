...
namespace WPXServerLight\WPBones\Foundation;

use WPXServerLight\WPBones\Container\Container;
use WPXServerLight\WPBones\Contracts\Foundation\Plugin as PluginContract;
use WPXServerLight\WPBones\Database\WordPressOption;
use WPXServerLight\WPBones\Foundation\Http\Request;
use WPXServerLight\WPBones\Foundation\Log\LogServiceProvider;
use WPXServerLight\WPBones\Support\Str;
use WPXServerLight\WPBones\View\View;
...
class Plugin extends Container implements PluginContract
{
    ...
    public function boot()
    {
         ...
         *
          ...
          Description = "WPX Server Light is a WP Bones boilperate plugin"
          DomainPath = "localization"
          Name = "WPX Server Light"
          Network = false
          PluginURI = "http://undolog.com"
          TextDomain = "wpx-server-light"
          Title = "WPX Server Light"
          Version = "1.0.0"
        ...
        // Load text domain
        load_plugin_textdomain("wpx-server-light", false, trailingslashit(basename($this->basePath)) . $this->pluginData['DomainPath']);
     ...
     *
     * @return \WPXServerLight\WPBones\View\View
     */
                    ...
                    if (isset($subMenu['route']['load'])) {
                        ...
                        add_action(
                            ...
                            function () use ($controller, $method) {
                                $className = "WPXServerLight\\Http\\Controllers\\{$controller}";
                                $instance  = new $className;
