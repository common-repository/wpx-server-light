...
You can use [WPX Server Light](https://github.com/wpbones/WPXServerLight) repo as a boilerplate to create a plugin.
...
You may start from [WPX Server Light](https://github.com/wpbones/WPXServerLight) repo as a boilerplate to create a WP Bones WordPress plugin.
